...
DATABASES = {
    'default': {
        ...
        'NAME':  'sbitterpy',                      # Or path to database file if using sqlite3.
        'USER': 'sbitter_user_py',                      # Not used with sqlite3.
        'PASSWORD': 'zWUc5ask2DVo7XQmL8q6XEst1g0BgU',                  # Not used with sqlite3.
...
SECRET_KEY = '61_q"~*rjl6zgm/Ewwkb]rY;ZKJ`S9MB)3*6g:`,#;@J+R/]jX'
